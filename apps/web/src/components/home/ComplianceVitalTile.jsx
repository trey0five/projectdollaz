  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2">
        <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-gold-gradient text-white shadow-[0_3px_10px_-2px_rgb(var(--c-glow)/0.55)] transition-transform duration-300 group-hover:scale-105 sm:h-10 sm:w-10">
          <Icon size={18} />
        </span>
        {summary && (
          <>
