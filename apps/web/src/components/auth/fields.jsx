...
export function FormError({ children }) {
  ...
  return (
    <div className="min-h-[20px] rounded-md bg-danger/10 px-3 py-2 text-center text-[13px] text-danger">
      {children}
    </div>
  )
}
...
export function FormSuccess({ children }) {
  ...
  return (
    <div className="rounded-md bg-emerald-500/10 px-3 py-2 text-center text-[13px] text-emerald-700">
      {children}
    </div>
  )
}
