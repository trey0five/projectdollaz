  ...
  return (
    <div className="card-soft sticky top-2 z-20 mb-5 flex flex-col gap-3 bg-white/95 px-4 py-3 backdrop-blur lg:flex-row lg:items-center lg:justify-between">
      ...
      <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
        ...
        <span className="inline-flex items-center gap-1.5 rounded-full border border-gold/40 bg-gold/10 px-2.5 py-0.5 text-[12px] font-semibold uppercase tracking-[0.1em] text-[#7a5e00]">
          <span
        ...
        {canCustomize && !customizing && (
          <button
            type="button"
            onClick={onCustomize}
            className="inline-flex min-h-[34px] items-center gap-1.5 rounded-lg border border-rule/60 px-3 py-1.5 text-[13px] font-semibold uppercase tracking-[0.08em] text-muted transition-colors hover:border-gold hover:text-navy"
          >
